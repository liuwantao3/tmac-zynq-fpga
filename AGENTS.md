...
12. **Bitstream rebuild (2026-07-12, SUPERSEDED by #24):** Vivado build completed. WNS=-0.360 ns (4 failing endpoints). BRAM18: 33→10 (Q5_0 clean-slate rewrite eliminated 14, Q8 smem/act LUTRAM saved 9). Slice LUTs: 9,898→9,066. LUT as Memory: 97→177. Slice Regs: 12,781→14,052. DSP48E1: 22→23. **Note: this 2026-07-12 bitstream lacked SDIO0 (PCW_EN_SDIO0=0). The frozen bitstream (2026-08-04, #24) adds SDIO0 and passes all HW tests — the resource numbers below remain current for the PL fabric.**
