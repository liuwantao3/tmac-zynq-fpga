...
# ===== Run =====
puts "Running (900s timeout). Console output is on the USB-UART0 terminal (115200 8N1)."
con
after 900000
...
# ===== UART note =====
puts "\n(Console output was on USB-UART0 at 115200 8N1; status/progress above read from DDR.)"
