...
- The Vitis GUI flow is documented in `linux/README.md` → "Vitis GUI workspace" (this board has no Ethernet, so execution is verified via JTAG boot + DDR markers; USB-UART on UART0 works)
