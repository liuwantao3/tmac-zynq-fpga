...
# this matches the Z7-Lite CH340 USB-UART. CONFIG_OF_EMBED=y bakes the
# DTB into the ELF so JTAG-booted U-Boot has its device tree.
# CONFIG_DEBUG_UART_ZYNQ enables early boot output before DM init.
