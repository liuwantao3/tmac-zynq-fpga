...
module matmul_q4k_core (
    ...
    // ======================================================================
    // Weight storage: 512 x 128-bit (2 BRAM36, pre-dequantized INT16 values)
    //   addr = {g[2:0], k[5:0]}
    //   data = {8 × INT16} = 8 pre-dequantized weights
    // ======================================================================
    (* ram_style = "block" *) reg [63:0] wmem_lo [0:511];
    (* ram_style = "block" *) reg [63:0] wmem_hi [0:511];

    // Byte-level write for Q4_K block loading
    ...
    // Synchronous read (combined 128-bit)
    ...
    // ======================================================================
    // Activation registers: 64 x 16-bit (same as Q8 core)
    // ======================================================================
    ...
    // ======================================================================
    // Single-bank accumulators: 64 x 48-bit (same as Q8 core)
    // ======================================================================
    ...
    // ======================================================================
    // Pipeline registers (3-stage, same structure as Q8 core)
    //   Stage 0: address wmem, read act (no scale read needed)
    //   Stage 1: multiply INT16 act × INT16 weight → INT32 partial
    //   Stage 2: accumulate
    // ======================================================================
    reg [2:0]  p1_g;
    reg [5:0]  p1_k;
    ...
    // ======================================================================
    // FSM (same as Q8 core, no smem reads)
    // ======================================================================
